...
serialInst.port = "/dev/ttyUSB0"  # Replace "/dev/ttyUSB0" with the correct port for your Arduino
serialInst.open()
...
def open_window(main_window):
    ...
    brightness_label.place(relx=0.3, rely=0.2, anchor=tk.CENTER)
    brightness_scale.place(relx=0.3, rely=0.3, anchor=tk.CENTER)
    color_button.place(relx=0.5, rely=0.3, anchor=tk.CENTER)
    pattern_button1.place(relx=0.3, rely=0.4, anchor=tk.CENTER)
    pattern_button2.place(relx=0.5, rely=0.4, anchor=tk.CENTER)
    pattern_button3.place(relx=0.7, rely=0.4, anchor=tk.CENTER)
    main_menu.place(relx=0.5, rely=0.6, anchor=tk.CENTER)
